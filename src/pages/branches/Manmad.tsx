...
const Manmad = () => {
  ...
  const specialPrograms = [
    "Abacus Competition Preparation",
  ...
  const testimonials = [
    {
      name: "Rajesh Patel",
      role: "Parent",
      content: "Very convenient location with excellent teaching quality. My children are excelling in their studies.",
      rating: 5
    },
    {
      name: "Anita Desai",
      role: "Parent",
      content: "The abacus training has significantly improved my child's concentration and mental abilities. Highly recommended!",
      rating: 5
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
              <div>
                <div className="text-3xl font-bold text-secondary mb-1">2022</div>
              ...
              <div>
                <div className="text-3xl font-bold text-secondary mb-1">1800</div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Contemporary infrastructure designed for effective learning
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Exclusive offerings at Manmad Branch
              </p>
            </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Feedback from our Manmad families
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-hero text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Visit Manmad Branch Today
          </h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Experience our excellent facilities and meet our dedicated faculty members
          </p>
